...
pub async fn print_justify_amex(
    ...
    let records = transaction.justify_amex().await?;
    ...
    struct Justification {
        ...
        excl_amex_cashback: String,
        #[tabled(rename = "Cashback in. Amex")]
        incl_amex_cashback: String,
        #[tabled(rename = "Diff")]
    ...
    let records = records.into_iter().map(|row| {
        ...
        Justification {
            ...
            incl_amex_cashback: format_coloured_balance(row.incl_amex_cashback),
            excl_amex_cashback: format_coloured_balance(row.excl_amex_cashback),
